    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      <div className="container mx-auto px-4 py-12">
        ...
        {!isLoading && books.length > 0 && (
          <>
            <div className="w-full max-w-7xl mx-auto mt-8 mb-4 flex items-center justify-between">
              ...
              <button
                ...
                disabled={isLoading}
                className="flex items-center gap-2 bg-white border-2 border-indigo-600 text-indigo-600 px-4 py-2 rounded-lg font-semibold hover:bg-indigo-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
